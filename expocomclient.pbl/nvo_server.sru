forward
global type nvo_server from dotnetobject
end type
end forward
...
global nvo_server nvo_server

type variables

PUBLIC:
String is_assemblypath = "COMServer.dll"
String is_classname = "COMServer.Server"
...
public function double of_computepi()
end prototypes
...
on nvo_server.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_server.destroy
